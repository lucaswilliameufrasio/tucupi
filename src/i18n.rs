...
fn pt_strings() -> &'static HashMap<&'static str, &'static str> {
    ...
    PT.get_or_init(|| {
        ...
        m.insert("help_tui", " [q] Sair | [Tab] Alternar Local/Global | [r] Atualizar Lista | [u] Upgrade Seguro | [f] Forçar Upgrade | [c] Checar Segurança | [l] Logs | [PgUp/PgDn] Rolar Detalhes ");
...
fn en_strings() -> &'static HashMap<&'static str, &'static str> {
    ...
    EN.get_or_init(|| {
        ...
        m.insert("help_tui", " [q] Quit | [Tab] Toggle Local/Global | [r] Refresh | [u] Safe Upgrade | [f] Force Upgrade | [c] Check Security | [l] Logs | [PgUp/PgDn] Scroll Details ");
